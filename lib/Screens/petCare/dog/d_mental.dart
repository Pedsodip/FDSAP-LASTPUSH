...
void main() {
  runApp(DogMentalPage());
}

class DogMentalPage extends StatelessWidget {
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildRichTextSection(
                      'Training Sessions ',
                      'Teach new tricks or skills to challenge your dog\'s mind and build a stronger bond.',
                    ),
                  ],
                ),
              ),
